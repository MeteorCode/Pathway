...
class Entity(gameID: Long,
  ...
  def this(gameID: Long) = this (gameID, null, null, null, null)
  def this(position: (Int, Int), grid: Grid) = this (null, position, grid, null)
  def this(name: String) = this(null, null, null, null, name)
  def this(gameID: Long, name:String) = this (gameID, null, null, null, name)
