 ...
 * <p>DON'T MAKE THESE - if you want to handle a file, please get it from an instance of
 * {@link com.meteorcode.pathway.io.ResourceManager ResourceManager}. The FileHandle system is supposed to allow you to
 * treat files in zip/jar archives as though they were on the filesystem as regular files, but this only works if you
 * treat all files you have to access as instances of {@link com.meteorcode.pathway.io.FileHandle FileHandle}. If you
 * ever refer to files as DesktopFileHandle, ZipFileHandle, or JarFileHandle explicitly in your code, you are doing the
 * Wrong Thing and negating a whole lot of time and effort I  put into this system. To reiterate: DO NOT CALL THE
 * CONSTRUCTOR FOR THIS.</p>
 *
 * @param logicalPath
 ...
 * @param manager
 * An { @link com.meteorcode.pathway.io.ResourceManager ResourceManager} managing this FileHandle
 * @author Hawk Weisman
 */
